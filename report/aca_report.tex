...
% Explain practical MPI choices, data distribution, synchronization, and profiling, space complexity


%ora spiega il ragionamento che avevi scritto da qualche parte, poi presenta le funzioni che usi e spiega pezzi di codice degni di nota. Quindi passa alla GCP.
