...
In Subsection~\ref{subsec:performance_analysis} it is highlighted how the \texttt{compute\discretionary{}{}{}Accelerations()} is the bottleneck of the serial algorithm, with a CPI ($0.41$), which is lower than 1.
